...
class TestExtraction(unittest.TestCase):
    ...
    def test_extract_images_various_markdown(self):
        matches = extract_markdown_images(
            "This is text with an image ![rick roll](https://i.imgur.com/aKaOqIh.gif) and link [to youtube](https://www.youtube.com/@bootdotdev)"
        )
        self.assertListEqual([("rick roll", "https://i.imgur.com/aKaOqIh.gif")], matches)

    def test_extract_links_various_markdown(self):
        matches = extract_markdown_links(
            "This is text with an image ![rick roll](https://i.imgur.com/aKaOqIh.gif) and link [to youtube](https://www.youtube.com/@bootdotdev)"
        )
